...
#writting to a file to record data
#creating the date and time
present = datetime.now()
date_string = present.strftime("%m,%d,%Y %H:%M:%S")
diff = time.time() - start
#opening file
f = open("c:/Users/usuik/Documents/GitHub/ECE4300_Fall_2021_Group_F/Project/Pauls_Test/basic.txt","a")
f.write("\n")
f.write(date_string)
f.write(f"\nMy program took {diff} seconds to run")
f.close()