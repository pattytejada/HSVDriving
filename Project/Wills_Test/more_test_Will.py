...
date = present.strftime("%m,%d,%Y %H:%M:%S")
difference = time.time() - start

file = open("c:/Users/WillT/source/repos/ECE4300_Fall_2021_Group_F/Project/Wills_Test/new_data.txt","a")
file.write("\n")
file.write(date)
file.write(f"\nMy program took {difference} seconds to run")
print("My program took", difference, "to run")
file.close()
